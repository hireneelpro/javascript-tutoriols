...
//  let family = [
//    { name: "hiren", age: 49, position: "techy", salary: 200 },
//    { name: "avni", age: 47, position: "shipper", salary: 300 },
//    { name: "karmit", age: 24, position: "programmer", salary: 400 },
//  ];
// console.log(family)
// let total = family.reduce(function (acc, curr) {
...
// const result = Math.floor(9.9999);
// const result = Math.ceil(9.9999);
// const result = Math.min(1,3,4,6,7,4,6,0.5);
// const result = Math.max(6, 5, 6, 5, 8, 9, 77, 88);
...
// console.log(days[cday])

// const cmonth = date.getMonth()
// console.log(months[cmonth])

// const cyear = date.getFullYear()
// console.log(cyear);

// console.log(`${days[cday]},${date.getDate()} ${months[cmonth]} ${date.getFullYear()}`)